angular.module('rtmms.enum').controller('EnumController', ['$scope', 'AuthService', 'dialogs', function($scope, AuthService, ResultsService, dialogs) {
...
angular.module('rtmms.enum').controller('EnumModalInstanceController', ['$scope', '$modalInstance', 'rosetta', 'MembersService', 'ResultsService', function($scope, $modalInstance, rosetta, RosettaService) {
